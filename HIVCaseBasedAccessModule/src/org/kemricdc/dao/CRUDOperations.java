...
//            System.out.printf("Person Details for %s Added Succesfully.", p.getFirstName());
    ...
    public MaritalStatusType getMaritalStatusType(int maritalStatusTypeId) {
        Session session = factory.openSession();
        Transaction tx = null;
        MaritalStatusType maritalStatusType = null;
        try {
            System.out.println("About to mine marital status type.....\n");
            tx = session.beginTransaction();
            maritalStatusType = (MaritalStatusType) session.get(MaritalStatusType.class, maritalStatusTypeId);
            System.out.println("\nAbout to commmit.......\n");
