 ...
 */
public class ProcessVisitInformationInsert {

    private TransactionSet set;
    private MaritalStatus ms;
    private Date cd4Instance;

    public ProcessVisitInformationInsert(TransactionSet set) {
        this.set = set;
    }

    public void processTblVisitInformationInsert() {
        AccessPerson ap;
        ...
        for (Transaction transaction : transactions) {
            ...
            switch (variable) {
                case "patient_id": {
                    visitPerson = ParsePerson.parsePerson(transaction);
                    break;
                }
                case "visit_date": {
                    //set the event date
