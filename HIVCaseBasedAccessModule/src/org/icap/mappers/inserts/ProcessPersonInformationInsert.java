 ...
 */
public class ProcessPersonInformationInsert {
...
//                            some code to assign the other source to the message
                ...
                case "transfer_date": {
                    ...
                    if (StringUtils.isNotEmpty(transferDate)) {
                        ...
                        transferFromFacility = ap.getTransferFacility();
                        transferFromLocation = ap.getTransferFrom();
                        ...
                        filler.setObservationValue(transferFromFacility + "_" + transferFromLocation);
                ...
                case "artstart_date": {
                    ...
                    if (StringUtils.isNotEmpty(artStart)) {
                        ...
                        filler.setCodingSystem("NA");
                        filler.setObservationSubId("1");
                        filler.setObservationValue(d.toString());
                        filler.setUnits("DATE");
                        filler.setResultStatus("P");
...
//                    filler.setDateOfLastNormalValue(new Date());
                ...
                case "who_stage": {
                    ...
                    if (StringUtils.isNotEmpty(whoStage)) {
                        OruFiller filler = new OruFiller();
...
//                    filler.setUnits("CM");
                        filler.setResultStatus("P");
//                    filler.setDateOfLastNormalValue(new Date());
                        d = ParseDateAndName.parseDate(ap.getDateEntered());
                       // filler.setDateTimeOfObservation(d);
                        filler.setDateTimeOfObservation(d);
                        fillers.add(filler);
                    }
...
//                    filler.setDateOfLastNormalValue(new Date());
                ...
                case "date_1stline_regimen": {
                    ...
                    if (StringUtils.isNotEmpty(dateFirstLineRegimen)) {
                        ...
                        regimenStarted = ap.getRegimenStarted();
...
////                        processEvent(f, e, person, d, d1);
//                        OruFiller filler = new OruFiller();
//                        filler.setObservationIdentifier("40801");
//                        filler.setObservationIdentifierText(Event.FIRST_LINE_REGIMEN.getValue());
//                        filler.setCodingSystem("NA");
//                        filler.setObservationSubId("1");
//                        filler.setObservationValue(regimenStarted);
...
//                }
                case "date_2ndline_regimen": {
                    ...
                    if (StringUtils.isNotEmpty(dateSecondLineRegimen)) {
                        ...
                        regimenSecondStarted = ap.getRegimenSecondStarted();
                        String switchReason = ap.getReasonSecondLineSwitch();
                        OruFiller filler = new OruFiller();
...
//                }
        ...
        prau.processRegistrationOrUpdate("A04");
